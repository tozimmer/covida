 ...
 *
 */
public class Covida_twtable implements Runnable {
    ...
    static Covida_twtable twserver;
     ...
     * @param opt
     */
    public Covida_twtable(TouchAndWriteCMDOptions opt) {
        this.opt = opt;
    }
    ...
    protected void init() {
        ...
        } else if (getClass().getClassLoader().getResource("conf/touchandwrite-table.xml") != null) {
            log.debug("Loading Touch And Write configuration. [Configuration location (Resources)]="
                    + "conf/touchandwrite-table.xml");
            conf = TouchAndWriteConfiguration.loadSettings(getClass().getClassLoader().getResource("conf/touchandwrite-table.xml"));
        } else {
            log.debug("Loading Touch And Write configuration [Default EEE Slate Config]");
            conf = TouchAndWriteConfiguration.getDefaultEEESlateConfig();
        }
    ...
    public static void main(String[] args) {
        ...
        if (opt.isDebug()) {
            ...
            log = Logger.getLogger(Covida_twtable.class);
        ...
        twserver = new Covida_twtable(opt);
