...
public abstract class Field extends CovidaComponent implements
    ...
    protected Map<Integer, ArrayList<String>> resultString = new HashMap<Integer, ArrayList<String>>();
    ...
    protected Map<Integer, Vector2f> lastTouch = new HashMap<Integer, Vector2f>();
