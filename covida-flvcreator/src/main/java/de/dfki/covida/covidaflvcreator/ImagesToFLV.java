 ...
 *
 * <p> You can find the original code <a
 * href="http://flexingineer.blogspot.com/2009/05/encoding-video-from-series-of-images.html"
 * > here </a>. </p>
 *
...
public class ImagesToFLV {
     ...
     * Logger
     */
    private static final Logger log = LoggerFactory.getLogger(ImagesToFLV.class);
     ...
     *
     * @param args The filename to write to.
     */
    public static void main(String[] args) {
        ...
        try {
            ImagesToFLV videoEncoder = new ImagesToFLV(outFile);
            int index = 0;
            while (index < 120 * videoEncoder.frameRate.getDouble()) {
        ...
        log.debug("End encoding. duration: {}",System.currentTimeMillis()-start);
    }
     ...
     */
    public ImagesToFLV(String outFile) {
        try {
            robot = new Robot();
        ...
        log.debug(screenBounds.toString());
